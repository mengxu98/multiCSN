...
Unlike \[aggregate_assay()\], which summarizes predefined cell groups
within a Seurat object, this function infers groups using PCA, a
neighbor graph and community detection. Input and output matrices are
cell-by-gene.
